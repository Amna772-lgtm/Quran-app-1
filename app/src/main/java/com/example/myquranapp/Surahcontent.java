...
import com.example.myquranapp.Qurandata;
import com.example.myquranapp.ParaSurah;
...
public class Surahcontent extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.surah_xml);
                ps = new ParaSurah();
                qd = new Qurandata();
                ayatTextView = findViewById(R.id.ayatEditText);
